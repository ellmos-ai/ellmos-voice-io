...
- [ ] Decide whether to retain the existing repository history or publish from a
  sanitized replacement history. Earlier commits retain a generic local
  development root and an earlier internal system name.
- [ ] Explicitly authorize the visibility change, tag, GitHub Release, and any
  package-registry publication as separate actions.
...
| **Overall technical gate** | **READY** | Public release remains owner-locked in `RELEASE_GATE.md` |

**Gate check exit code:** `0` after the 2026-08-21 remediation
